...
restaurantRouter.post(
  "/toggle-restaurant-status/:restaurantId",
...
restaurantRouter.put(
  "/update-password/:id",
  expressAsyncHandler(restaurantController.updateRestaurantPassword)
);

restaurantRouter.get(
  "/get-restaurant-by-token",
  expressAsyncHandler(restaurantController.getLoggedInRestaurant)
);
